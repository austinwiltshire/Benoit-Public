...
class YahooTestCase(unittest.TestCase):
	...
	def testRandom(self):
		...
		self.assertEqual(Yahoo2.getAdjustedClose("DD", datetime.date(2004,8,10)), 32.19)
		self.assertEqual(Yahoo2.getAdjustedClose("DD", datetime.date(2004,5,12)), 32.08)
		self.assertEqual(Yahoo2.getAdjustedClose("DD", datetime.date(2004,5,11)), 32.00)
		self.assertEqual(Yahoo2.getAdjustedClose("DD", datetime.date(1969,12,31)), 1.10)
		self.assertEqual(Yahoo2.getAdjustedClose("DD", datetime.date(2008,6,4)), 41.1)
