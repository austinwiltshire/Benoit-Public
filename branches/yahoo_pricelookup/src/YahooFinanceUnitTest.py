...
class YahooTestCase(unittest.TestCase):
    ...
    def testRandom(self):
        ...
        self.assertEqual(historical_prices.getAdjustedClose("DD", datetime.datetime(2004,8,10)), 32.19)
        self.assertEqual(historical_prices.getAdjustedClose("DD", datetime.datetime(2004,5,12)), 32.08)
        self.assertEqual(historical_prices.getAdjustedClose("DD", datetime.datetime(2004,5,11)), 32.00)
        self.assertEqual(historical_prices.getAdjustedClose("DD", datetime.datetime(1969,12,31)), 1.10)
        self.assertEqual(historical_prices.getAdjustedClose("DD", datetime.datetime(2008,6,4)), 41.1)
